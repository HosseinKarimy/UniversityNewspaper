...
public class UpdateBannerHandler(IBannerRepository bannerRepository) : ICommandHandler<UpdateBannerCommand, UpdateBannerResult>
{
    ...
    private async Task<Banner> GetBannersAsync(UpdateBannerDto bannerDto, CancellationToken cancellationToken)
    {
    ...
    private static void UpdateBannerObject(Banner banner, UpdateBannerDto bannerDto)
    {
    ...
    private static void AuthorizeRequest(Banner banner, UpdateBannerCommand request)
    {
