...
public class BannerRepository : IBannerRepository
{
    ...
    public async Task<GoodsBanner> AddBannerAsync(GoodsBanner banner, CancellationToken cancellationToken)
    {
    ...
    public async Task<List<GoodsBanner>> GetAllBannersAsync(CancellationToken cancellationToken = default)
    {
    ...
    public async Task<bool> UpdateBannerAsync(GoodsBanner banner, CancellationToken cancellationToken = default)
    {
